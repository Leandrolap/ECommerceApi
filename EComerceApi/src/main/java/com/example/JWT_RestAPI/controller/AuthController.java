...
public class AuthController {
    ...
    @Secured("GERT")
    @GetMapping("/gerentes")
    public String onlyGERT(Authentication authentication) {
        return "gerentes: " + authentication.getName();
    }

    @Secured("VEND")
    @GetMapping("/vendedores")
    public String onlyVEND(Authentication authentication) {
        return "vendedores: " + authentication.getName();
    }
}
